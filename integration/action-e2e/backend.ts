...
export interface Handlers<Tx> {
 addTodo: { v1(call: ActionHandlerCall<Tx, AddTodoInput>): Promise<AddTodoHandlerOutput> } | ((call: ActionHandlerCall<Tx, AddTodoInput>) => Promise<AddTodoHandlerOutput>);
 ...
 searchTodos: { v1(call: ActionHandlerCall<Tx, SearchTodosInput>): Promise<SearchTodosHandlerOutput> } | ((call: ActionHandlerCall<Tx, SearchTodosInput>) => Promise<SearchTodosHandlerOutput>);
 ...
 updateTodo: { v1(call: ActionHandlerCall<Tx, UpdateTodoInput>): Promise<UpdateTodoHandlerOutput> } | ((call: ActionHandlerCall<Tx, UpdateTodoInput>) => Promise<UpdateTodoHandlerOutput>);
}
