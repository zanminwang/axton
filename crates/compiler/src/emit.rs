...
pub fn client_typescript(v: &Value, runtime: &str) -> String {
    ...
    writeln!(o, "export {{ ActionError, type ActionCall, type ActionOptions, type ActionOutcome, type ActionStatus, type ServerOptions, type Connection, type ConnectionOptions, type BootstrapPhase, type BootstrapStatus, type Subscription, type SubscriptionStatus }} from \"{runtime}\";").unwrap();
