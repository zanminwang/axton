...
export function makeMutations(port:CallPort) { return {
 ...
 setTodoDone: (args:SetTodoDoneInput, options?:SetTodoDoneOptions):Promise<Call<SetTodoDoneOutput>> => port.invokeAction('SetTodoDone',1,encodeSetTodoDoneInput(args),decodeSetTodoDoneOutput,options),
 call: {
