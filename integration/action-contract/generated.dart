...
class Actions {
 ...
 Future<ActionCall<AddTodoOutput>> addTodo({required TodoCreate todo, AddTodoPatchUpdate? patch, required List<TodoDelete> gone, required Status? status, required List<String> tags}) => client.invokeAction<AddTodoOutput>('AddTodo', 2, {'todo': _dartActionEncode(todo), if (patch != null) 'patch': _dartActionEncode(patch), 'gone': _dartActionEncode(gone), 'status': _dartActionEncode(status), 'tags': _dartActionEncode(tags)}, (value) { final row = (value as Map).cast<String,dynamic>(); return AddTodoOutput(todo: Todo.fromRecord((row['todo'] as Map).cast<String,dynamic>()), patch: row['patch'] == null ? null : Todo.fromRecord((row['patch'] as Map).cast<String,dynamic>()), gone: (row['gone'] as List).map((e) => TodoIdentity.fromRecord((e as Map).cast<String,dynamic>())).toList(), relatedTodo: row['relatedTodo'] == null ? null : Todo.fromRecord((row['relatedTodo'] as Map).cast<String,dynamic>()), matches: (row['matches'] as List).map((e) => Todo.fromRecord((e as Map).cast<String,dynamic>())).toList(), count: row['count'] as int, state: row['state'] == null ? null : Status.values.byName(row['state'] as String)); });
 ...
 Future<ActionCall<GetTodosOutput>> getTodos() => client.invokeAction<GetTodosOutput>('GetTodos', 1, {}, (value) { final row = (value as Map).cast<String,dynamic>(); return GetTodosOutput(todos: (row['todos'] as List).map((e) => Todo.fromRecord((e as Map).cast<String,dynamic>())).toList()); });
 Future<ActionCall<LinkOutput>> link({required ProjectCreate project}) => client.invokeAction<LinkOutput>('Link', 1, {'project': _dartActionEncode(project)}, (value) { final row = (value as Map).cast<String,dynamic>(); return LinkOutput(project: Project.fromRecord((row['project'] as Map).cast<String,dynamic>()), relatedProject: row['relatedProject'] == null ? null : Project.fromRecord((row['relatedProject'] as Map).cast<String,dynamic>())); });
 Future<ActionCall<PingOutput>> ping() => client.invokeAction<PingOutput>('Ping', 1, {}, (_) {});
 Future<ActionCall<RemoveTodoOutput>> removeTodo({required TodoDelete todo}) => client.invokeAction<RemoveTodoOutput>('RemoveTodo', 1, {'todo': _dartActionEncode(todo)}, (value) { final row = (value as Map).cast<String,dynamic>(); return RemoveTodoOutput(todo: TodoIdentity.fromRecord((row['todo'] as Map).cast<String,dynamic>())); });
 Future<ActionCall<SearchOutput>> search({required String? query}) => client.invokeAction<SearchOutput>('Search', 1, {'query': _dartActionEncode(query)}, (_) {});
 Future<ActionCall<SendEmailOutput>> sendEmail({required String to, required String subject, required String body}) => client.invokeAction<SendEmailOutput>('SendEmail', 1, {'to': _dartActionEncode(to), 'subject': _dartActionEncode(subject), 'body': _dartActionEncode(body)}, (_) {});
 Future<ActionCall<StateListOutput>> stateList() => client.invokeAction<StateListOutput>('StateList', 2, {}, (value) { final row = (value as Map).cast<String,dynamic>(); return StateListOutput(states: (row['states'] as List).map((e) => Status.values.byName(e as String)).toList()); });
}
class DirectCalls {
 final Client client; DirectCalls(this.client);
 Future<AddTodoOutput> addTodo({required TodoCreate todo, AddTodoPatchUpdate? patch, required List<TodoDelete> gone, required Status? status, required List<String> tags}) => client.invokeDirectAction<AddTodoOutput>('AddTodo', 2, {'todo': _dartActionEncode(todo), if (patch != null) 'patch': _dartActionEncode(patch), 'gone': _dartActionEncode(gone), 'status': _dartActionEncode(status), 'tags': _dartActionEncode(tags)}, (value) { final row = (value as Map).cast<String,dynamic>(); return AddTodoOutput(todo: Todo.fromRecord((row['todo'] as Map).cast<String,dynamic>()), patch: row['patch'] == null ? null : Todo.fromRecord((row['patch'] as Map).cast<String,dynamic>()), gone: (row['gone'] as List).map((e) => TodoIdentity.fromRecord((e as Map).cast<String,dynamic>())).toList(), relatedTodo: row['relatedTodo'] == null ? null : Todo.fromRecord((row['relatedTodo'] as Map).cast<String,dynamic>()), matches: (row['matches'] as List).map((e) => Todo.fromRecord((e as Map).cast<String,dynamic>())).toList(), count: row['count'] as int, state: row['state'] == null ? null : Status.values.byName(row['state'] as String)); });
 ...
 Future<GetTodosOutput> getTodos() => client.invokeDirectAction<GetTodosOutput>('GetTodos', 1, {}, (value) { final row = (value as Map).cast<String,dynamic>(); return GetTodosOutput(todos: (row['todos'] as List).map((e) => Todo.fromRecord((e as Map).cast<String,dynamic>())).toList()); });
 Future<LinkOutput> link({required ProjectCreate project}) => client.invokeDirectAction<LinkOutput>('Link', 1, {'project': _dartActionEncode(project)}, (value) { final row = (value as Map).cast<String,dynamic>(); return LinkOutput(project: Project.fromRecord((row['project'] as Map).cast<String,dynamic>()), relatedProject: row['relatedProject'] == null ? null : Project.fromRecord((row['relatedProject'] as Map).cast<String,dynamic>())); });
 Future<PingOutput> ping() => client.invokeDirectAction<PingOutput>('Ping', 1, {}, (_) {});
 Future<RemoveTodoOutput> removeTodo({required TodoDelete todo}) => client.invokeDirectAction<RemoveTodoOutput>('RemoveTodo', 1, {'todo': _dartActionEncode(todo)}, (value) { final row = (value as Map).cast<String,dynamic>(); return RemoveTodoOutput(todo: TodoIdentity.fromRecord((row['todo'] as Map).cast<String,dynamic>())); });
 Future<SearchOutput> search({required String? query}) => client.invokeDirectAction<SearchOutput>('Search', 1, {'query': _dartActionEncode(query)}, (_) {});
 Future<SendEmailOutput> sendEmail({required String to, required String subject, required String body}) => client.invokeDirectAction<SendEmailOutput>('SendEmail', 1, {'to': _dartActionEncode(to), 'subject': _dartActionEncode(subject), 'body': _dartActionEncode(body)}, (_) {});
 Future<StateListOutput> stateList() => client.invokeDirectAction<StateListOutput>('StateList', 2, {}, (value) { final row = (value as Map).cast<String,dynamic>(); return StateListOutput(states: (row['states'] as List).map((e) => Status.values.byName(e as String)).toList()); });
}
