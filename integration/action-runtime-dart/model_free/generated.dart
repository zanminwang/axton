...
class ClockV1Input implements _DartActionRecord {
 final DateTime at;
 const ClockV1Input({required this.at});
...
abstract interface class MutationHandlers<Ctx> {
 MutationClockHandlers<Ctx> get clock;
 MutationPingHandlers<Ctx> get ping;
}
abstract interface class MutationClockHandlers<Ctx> {
