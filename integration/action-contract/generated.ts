...
export function makeQueries(port:CallPort) { return {
 findTodos: (args:FindTodosInput, options?:FindTodosOptions):Promise<FindTodosOutput> => port.invokeDirectAction('FindTodos',1,encodeFindTodosInput(args),decodeFindTodosOutput,options),
 getTodos: (args:GetTodosInput, options?:GetTodosOptions):Promise<GetTodosOutput> => port.invokeDirectAction('GetTodos',2,encodeGetTodosInput(args),decodeGetTodosOutput,options),
 enqueue: {
