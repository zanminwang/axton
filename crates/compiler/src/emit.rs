...
pub fn client_typescript(v: &Value, runtime: &str) -> String {
    ...
    writeln!(o, "export {{ ActionError, type ActionCall, type ActionOutcome, type ActionStatus, type ServerOptions, type Connection, type ConnectionOptions, type Subscription, type SubscriptionStatus }} from \"{runtime}\";").unwrap();
