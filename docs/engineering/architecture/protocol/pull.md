...
- The canonical bootstrap request and page and every case in [bootstrap-request.json](../../../../fixtures/protocol/bootstrap-request.json) and [bootstrap-page.json](../../../../fixtures/protocol/bootstrap-page.json) decode as declared: an unknown, null, numeric or missing mode, missing and unsafe counters, `after > until`, a blank channel, `to > until`, `until > head`, a page over the record limit, and either mode decoded as the other. Evidence: [core/tests/contracts.rs](../../../../crates/core/tests/contracts.rs) `bootstrap_request_fixture_cases_decode_as_declared`, `bootstrap_page_fixture_cases_decode_as_declared`.
