...
abstract interface class ActionHandlers<Ctx> {
 ...
 ActionSetTodoDoneHandlers<Ctx> get setTodoDone;
}
abstract interface class ActionAddTodoHandlers<Ctx> {
 Future<AddTodoHandlerOutput> v1(ActionHandlerCall<Ctx, AddTodoInput> call);
}
abstract interface class ActionSetTodoDoneHandlers<Ctx> {
 Future<SetTodoDoneHandlerOutput> v1(ActionHandlerCall<Ctx, SetTodoDoneInput> call);
}
