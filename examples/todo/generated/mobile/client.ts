...
import { Client, type ClientSyncState, type Connection, type ConnectionOptions, type QuerySpec, type RebuildReport, type RecordValue, type ServerOptions, type Subscription } from "../../../../packages/client-react-native/index.ts";
export { CallError, type Call, type CallOptions, type CallOutcome, type CallStatus, type OnceOptions, type ServerOptions, type Connection, type ConnectionOptions, type BootstrapPhase, type BootstrapStatus, type Subscription, type SubscriptionStatus } from "../../../../packages/client-react-native/index.ts";
import { schema, liveModels, makeMutations, makeQueries, GeneratedTransaction, type LiveModels } from "./generated.ts";
...
export class GeneratedClient {
 ...
 private constructor(client: Client, connection: Connection | undefined) { this.client = client; this.connection = connection; this.models = liveModels(client); this.mutations = makeMutations(client); this.queries = makeQueries(client); this.scopes = new Scopes(client); this.channels = new Channels(client); }
