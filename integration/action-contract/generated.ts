...
export type RemoveTodoOutput = void;
...
function encodeEditInput(args:EditInput):Record<string,unknown> { return {
...
function encodeEditAndReadInput(args:EditAndReadInput):Record<string,unknown> { return {
 todo: {...encodeTodoIdentity(args.todo),...encodeTodoPatch(args.todo)},
}; }
function decodeEditAndReadOutput(value:unknown):EditAndReadOutput { const row=value as Record<string,unknown>; return {
 todo: decodeTodo(row.todo as Record<string,unknown>),
}; }
function encodeFindTodosInput(args:FindTodosInput):Record<string,unknown> { return {
 text: args.text,
 cursor: args.cursor === null ? null : args.cursor,
}; }
function decodeFindTodosOutput(value:unknown):FindTodosOutput { const row=value as Record<string,unknown>; return {
 todos: (row.todos as unknown[]).map(value => decodeTodo(value as Record<string,unknown>)),
 nextCursor: row.nextCursor == null ? null : row.nextCursor as string,
}; }
...
function decodeRemoveTodoOutput(_value:unknown):void { return undefined; }
...
/** Invocation options for Edit; `store` selects which explicit Model outputs also update local Models. */
export type EditOptions = { store?: boolean };
/** Invocation options for EditAndRead; `store` selects which explicit Model outputs also update local Models. */
export type EditAndReadOptions = CallOptions<'todo'>;
/** Invocation options for FindTodos; `store` selects which explicit Model outputs also update local Models. */
export type FindTodosOptions = CallOptions<'todos'>;
/** Invocation options for GetTodos; `store` selects which explicit Model outputs also update local Models. */
export type GetTodosOptions = CallOptions<'todos'>;
/** Invocation options for Link; `store` selects which explicit Model outputs also update local Models. */
export type LinkOptions = CallOptions<'relatedProject'>;
/** Invocation options for OpenTodo; `store` selects which explicit Model outputs also update local Models. */
export type OpenTodoOptions = CallOptions<'mainTodo'|'suggestions'|'related'>;
...
export function makeMutations(port:CallPort) { return {
 ...
 edit: (args:EditInput, options?:EditOptions):Promise<Call<EditOutput>> => port.invokeAction('Edit',1,encodeEditInput(args),decodeEditOutput,options),
 editAndRead: (args:EditAndReadInput, options?:EditAndReadOptions):Promise<Call<EditAndReadOutput>> => port.invokeAction('EditAndRead',1,encodeEditAndReadInput(args),decodeEditAndReadOutput,options),
 ...
 openTodo: (args:OpenTodoInput, options?:OpenTodoOptions):Promise<Call<OpenTodoOutput>> => port.invokeAction('OpenTodo',1,encodeOpenTodoInput(args),decodeOpenTodoOutput,options),
 ...
 removeTodo: (args:RemoveTodoInput, options?:RemoveTodoOptions):Promise<Call<RemoveTodoOutput>> => port.invokeAction('RemoveTodo',1,encodeRemoveTodoInput(args),decodeRemoveTodoOutput,options),
 search: (args:SearchInput, options?:SearchOptions):Promise<Call<SearchOutput>> => port.invokeAction('Search',1,encodeSearchInput(args),decodeSearchOutput,options),
 ...
 call: {
  ...
  edit: (args:EditInput, options?:EditOptions):Promise<EditOutput> => port.invokeDirectAction('Edit',1,encodeEditInput(args),decodeEditOutput,options),
  editAndRead: (args:EditAndReadInput, options?:EditAndReadOptions):Promise<EditAndReadOutput> => port.invokeDirectAction('EditAndRead',1,encodeEditAndReadInput(args),decodeEditAndReadOutput,options),
...
export function makeQueries(port:CallPort) { return {
 findTodos: (args:FindTodosInput, options?:FindTodosOptions & OnceOptions):Promise<FindTodosOutput> => port.invokeQuery('FindTodos',1,encodeFindTodosInput(args),decodeFindTodosOutput,options),
 getTodos: (args:GetTodosInput, options?:GetTodosOptions & OnceOptions):Promise<GetTodosOutput> => port.invokeQuery('GetTodos',2,encodeGetTodosInput(args),decodeGetTodosOutput,options),
 enqueue: {
  findTodos: (args:FindTodosInput, options?:FindTodosOptions):Promise<Call<FindTodosOutput>> => port.invokeAction('FindTodos',1,encodeFindTodosInput(args),decodeFindTodosOutput,options),
  getTodos: (args:GetTodosInput, options?:GetTodosOptions):Promise<Call<GetTodosOutput>> => port.invokeAction('GetTodos',2,encodeGetTodosInput(args),decodeGetTodosOutput,options),
 },
 invalidate: {
  findTodos: (args:FindTodosInput):Promise<void> => port.invalidateQuery('FindTodos',1,encodeFindTodosInput(args)),
