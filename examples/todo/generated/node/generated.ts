...
export function makeActions(port:ActionPort) { return {
 ...
 setTodoDone: (args:SetTodoDoneInput):Promise<ActionCall<SetTodoDoneOutput>> => port.invokeAction('SetTodoDone',1,encodeSetTodoDoneInput(args),decodeSetTodoDoneOutput),
 call: {
  ...
  setTodoDone: (args:SetTodoDoneInput):Promise<SetTodoDoneOutput> => port.invokeDirectAction('SetTodoDone',1,encodeSetTodoDoneInput(args),decodeSetTodoDoneOutput),
 }
}; }
