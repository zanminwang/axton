...
export interface Handlers<Ctx> {
 ...
 stateList: { v1(call: ActionHandlerCall<Ctx, StateListV1Input>): Promise<StateListV1HandlerOutput>; v2(call: ActionHandlerCall<Ctx, StateListInput>): Promise<StateListHandlerOutput> };
}
