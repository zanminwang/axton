...
export function makeQueries(port:CallPort) { return {
 searchTodos: (args:SearchTodosInput, options?:SearchTodosOptions):Promise<SearchTodosOutput> => port.invokeDirectAction('SearchTodos',3,encodeSearchTodosInput(args),decodeSearchTodosOutput,options),
 enqueue: {
