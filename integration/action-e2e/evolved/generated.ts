...
export function makeActions(port:ActionPort) { return {
 ...
 searchTodos: (args:SearchTodosInput):Promise<ActionCall<SearchTodosOutput>> => port.invokeAction('SearchTodos',2,encodeSearchTodosInput(args),decodeSearchTodosOutput),
 ...
 updateTodo: (args:UpdateTodoInput):Promise<ActionCall<UpdateTodoOutput>> => port.invokeAction('UpdateTodo',2,encodeUpdateTodoInput(args),decodeUpdateTodoOutput),
 call: {
  ...
  searchTodos: (args:SearchTodosInput):Promise<SearchTodosOutput> => port.invokeDirectAction('SearchTodos',2,encodeSearchTodosInput(args),decodeSearchTodosOutput),
  ...
  updateTodo: (args:UpdateTodoInput):Promise<UpdateTodoOutput> => port.invokeDirectAction('UpdateTodo',2,encodeUpdateTodoInput(args),decodeUpdateTodoOutput),
 }
}; }
