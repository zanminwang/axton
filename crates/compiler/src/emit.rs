...
pub fn client_typescript(v: &Value, runtime: &str) -> String {
    ...
    writeln!(o, "export {{ CallError, type Call, type CallOptions, type CallOutcome, type CallStatus, type OnceOptions, type ServerOptions, type Connection, type ConnectionOptions, type Subscription, type SubscriptionStatus }} from \"{runtime}\";").unwrap();
