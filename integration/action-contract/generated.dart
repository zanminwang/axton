...
class AddNotesOutput implements _DartActionRecord {
 final Note saved;
 const AddNotesOutput({required this.saved});
 Map<String,dynamic> toRecord() => {
...
class AddTodoOutput implements _DartActionRecord {
 ...
 final int count;
 final Status? state;
 const AddTodoOutput({required this.relatedTodo,required this.matches,required this.count,required this.state});
 Map<String,dynamic> toRecord() => {
 'relatedTodo': _dartActionEncode(relatedTodo),
 'matches': _dartActionEncode(matches),
 'count': _dartActionEncode(count),
...
typedef DeleteTodoOutput = void;
typedef DeleteTodoHandlerOutput = void;
class EditTodoUpdate implements _DartActionRecord {
 final String id;
 final Present<String>? title;
 final Present<Status>? state;
 final Present<String?>? note;
 const EditTodoUpdate({required this.id,this.title,this.state,this.note});
 Map<String,dynamic> toRecord() => {
 'id': _dartActionEncode(id),
 if (title != null) 'title': _dartActionEncode(title!.value),
 if (state != null) 'state': _dartActionEncode(state!.value),
...
class EditAndReadTodoUpdate implements _DartActionRecord {
 final String id;
 final Present<String>? title;
 final Present<Status>? state;
 final Present<String?>? note;
 const EditAndReadTodoUpdate({required this.id,this.title,this.state,this.note});
 Map<String,dynamic> toRecord() => {
 'id': _dartActionEncode(id),
 if (title != null) 'title': _dartActionEncode(title!.value),
 if (state != null) 'state': _dartActionEncode(state!.value),
...
class EditAndReadInput implements _DartActionRecord {
 ...
 const EditAndReadInput({required this.todo});
 Map<String,dynamic> toRecord() => {
 'todo': _dartActionEncode(todo),
 };
}
class EditAndReadOutput implements _DartActionRecord {
 final Todo todo;
 const EditAndReadOutput({required this.todo});
 Map<String,dynamic> toRecord() => {
 'todo': _dartActionEncode(todo),
 };
}
class EditAndReadHandlerOutput implements _DartActionRecord {
 ...
 const EditAndReadHandlerOutput({required this.todo});
 Map<String,dynamic> toRecord() => {
 'todo': _dartActionEncode(todo),
 };
}
...
class LinkOutput implements _DartActionRecord {
 ...
 const LinkOutput({required this.relatedProject});
 Map<String,dynamic> toRecord() => {
...
abstract interface class MutationHandlers<Ctx> {
 ...
 MutationEditHandlers<Ctx> get edit;
 MutationEditAndReadHandlers<Ctx> get editAndRead;
