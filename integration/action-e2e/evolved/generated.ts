...
export type SearchTodosOptions = ActionOptions<'todos'|'first'>;
...
export function makeActions(port:ActionPort) { return {
 ...
 searchTodos: (args:SearchTodosInput, options?:SearchTodosOptions):Promise<ActionCall<SearchTodosOutput>> => port.invokeAction('SearchTodos',2,encodeSearchTodosInput(args),decodeSearchTodosOutput,options),
 ...
 updateTodo: (args:UpdateTodoInput, options?:UpdateTodoOptions):Promise<ActionCall<UpdateTodoOutput>> => port.invokeAction('UpdateTodo',2,encodeUpdateTodoInput(args),decodeUpdateTodoOutput,options),
 call: {
  ...
  searchTodos: (args:SearchTodosInput, options?:SearchTodosOptions):Promise<SearchTodosOutput> => port.invokeDirectAction('SearchTodos',2,encodeSearchTodosInput(args),decodeSearchTodosOutput,options),
