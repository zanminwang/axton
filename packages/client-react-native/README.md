...
React Native host integration for the existing Rust/SQLite client. The generated TypeScript models, Mutations and Queries are shared with Node. Native calls, transaction scope, and HTTP/WebSocket transport use the mobile environment.
