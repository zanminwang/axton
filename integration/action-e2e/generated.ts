...
export function makeActions(port:ActionPort) { return {
 ...
 searchTodos: (args:SearchTodosInput, options?:SearchTodosOptions):Promise<ActionCall<SearchTodosOutput>> => port.invokeAction('SearchTodos',1,encodeSearchTodosInput(args),decodeSearchTodosOutput,options),
 ...
 updateTodo: (args:UpdateTodoInput, options?:UpdateTodoOptions):Promise<ActionCall<UpdateTodoOutput>> => port.invokeAction('UpdateTodo',1,encodeUpdateTodoInput(args),decodeUpdateTodoOutput,options),
 call: {
  ...
  searchTodos: (args:SearchTodosInput, options?:SearchTodosOptions):Promise<SearchTodosOutput> => port.invokeDirectAction('SearchTodos',1,encodeSearchTodosInput(args),decodeSearchTodosOutput,options),
