...
abstract interface class ActionSearchTodosHandlers<Ctx> {
 Future<SearchTodosHandlerOutput> v1(ActionHandlerCall<Ctx, SearchTodosInput> call);
}
...
abstract interface class ActionUpdateTodoHandlers<Ctx> {
 Future<UpdateTodoHandlerOutput> v1(ActionHandlerCall<Ctx, UpdateTodoInput> call);
}
...
class Actions {
 ...
 Future<ActionCall<SearchTodosOutput>> searchTodos({required String? query}) => client.invokeAction<SearchTodosOutput>('SearchTodos', 1, {'query': _dartActionEncode(query)}, (value) { final row = (value as Map).cast<String,dynamic>(); return SearchTodosOutput(todos: (row['todos'] as List).map((e) => Todo.fromRecord((e as Map).cast<String,dynamic>())).toList(), first: row['first'] == null ? null : Todo.fromRecord((row['first'] as Map).cast<String,dynamic>()), count: row['count'] as int, labels: (row['labels'] as List).map((e) => e as String).toList(), hint: row['hint'] == null ? null : row['hint'] as String); });
 ...
 Future<ActionCall<UpdateTodoOutput>> updateTodo({required UpdateTodoTodoUpdate todo}) => client.invokeAction<UpdateTodoOutput>('UpdateTodo', 1, {'todo': _dartActionEncode(todo)}, (value) { final row = (value as Map).cast<String,dynamic>(); return UpdateTodoOutput(todo: Todo.fromRecord((row['todo'] as Map).cast<String,dynamic>())); });
}
class DirectCalls {
 ...
 Future<SearchTodosOutput> searchTodos({required String? query}) => client.invokeDirectAction<SearchTodosOutput>('SearchTodos', 1, {'query': _dartActionEncode(query)}, (value) { final row = (value as Map).cast<String,dynamic>(); return SearchTodosOutput(todos: (row['todos'] as List).map((e) => Todo.fromRecord((e as Map).cast<String,dynamic>())).toList(), first: row['first'] == null ? null : Todo.fromRecord((row['first'] as Map).cast<String,dynamic>()), count: row['count'] as int, labels: (row['labels'] as List).map((e) => e as String).toList(), hint: row['hint'] == null ? null : row['hint'] as String); });
 ...
 Future<UpdateTodoOutput> updateTodo({required UpdateTodoTodoUpdate todo}) => client.invokeDirectAction<UpdateTodoOutput>('UpdateTodo', 1, {'todo': _dartActionEncode(todo)}, (value) { final row = (value as Map).cast<String,dynamic>(); return UpdateTodoOutput(todo: Todo.fromRecord((row['todo'] as Map).cast<String,dynamic>())); });
}
