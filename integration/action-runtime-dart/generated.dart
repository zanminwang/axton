...
class NowOutput implements _DartActionRecord {
 final DateTime at;
 const NowOutput({required this.at});
 Map<String,dynamic> toRecord() => {
 'at': _dartActionEncode(at),
 };
}
class NowHandlerOutput implements _DartActionRecord {
 final DateTime at;
 const NowHandlerOutput({required this.at});
 Map<String,dynamic> toRecord() => {
 'at': _dartActionEncode(at),
 };
}
...
abstract interface class MutationHandlers<Ctx> {
 MutationEchoHandlers<Ctx> get echo;
